...
func (r SovereignFactory) MarshalJSON() ([]byte, error) {
	var concrete struct{}
	return json.Marshal(&concrete)
}

func (r *SovereignFactory) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	_ = inputArgs
	switch parentName {
	case "SovereignFactory":
		switch fnName {
		case "ContainerEcho":
			var parent SovereignFactory
			...
			return (*SovereignFactory).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent SovereignFactory
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*SovereignFactory).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
